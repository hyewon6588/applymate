...
async def upload_resume(
    ...
    result = await upload_to_supabase(file, user_id)

    # Save metadata to MongoDB
    save_resume_entry(user_id, file_type, result["public_url"], result["size"])

    return {"message": "Upload successful", "url": result["public_url"]}
